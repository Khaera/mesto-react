...
function Card ( { card, onCardClick, onDeleteCard, onCardLike } ) {
  ...
  const cardLikeButtonClassName = `element__like-image ${isLiked ? 'element__like_active' : ''}`;
  ...
  return (
    ...
    <div className="element__info">
      ...
      <button type="button" className="element__like">
        <img src={likeImage} alt="Кнопка Лайк" className={cardLikeButtonClassName} onClick={handleLikeClick} />
